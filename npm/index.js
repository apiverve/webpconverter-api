...
class webpconverterWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/webpconverter');
        }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/webpconverter`);
        }
    }
    ...
    async executeWithFile(file, options = {}, callback) {
        ...
        if (!file) {
            throw new Error('File must be provided for file upload. See documentation: https://docs.apiverve.com/ref/webpconverter');
        }
        ...
        if (typeof file === 'string') {
            ...
            throw new Error('File must be a file path (string), Buffer, or ReadStream. See documentation: https://docs.apiverve.com/ref/webpconverter');
        }
    ...
    async executeWithUrl(url, options = {}, callback) {
        ...
        if (!url || typeof url !== 'string') {
            throw new Error('URL must be provided as a string. See documentation: https://docs.apiverve.com/ref/webpconverter');
        }
...
module.exports = webpconverterWrapper;
