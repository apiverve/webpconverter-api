...
namespace APIVerve.API.WebPConverter
{
    ...
    /// <summary>
    /// Client for the WebPConverter API
    /// </summary>
...
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/webpconverter";
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public WebPConverterAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public WebPConverterAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, WebPConverterQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(WebPConverterQueryOptions options)
        {
        ...
        public ResponseObj Execute(WebPConverterQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(WebPConverterQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(WebPConverterQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(WebPConverterQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(WebPConverterQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(WebPConverterQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(WebPConverterQueryOptions options)
        {
